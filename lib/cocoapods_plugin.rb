...
Pod::HooksManager.register('dm-cocoapods-fix-react-native', :pre_install) do |context|
...
Pod::HooksManager.register('dm-cocoapods-fix-react-native', :post_install) do |context|
